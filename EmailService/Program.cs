...
public class EmailService
{
    public void Consume()
    {
        ...
        channel.QueueDeclare(queue: "tours_email_queue", durable: true, exclusive: false, autoDelete: false, arguments: arguments);
        ...
        channel.BasicConsume(queue: "tours_email_queue", autoAck: false, consumer: emailConsumer);
        Console.WriteLine("Email Service: Press [enter] to exit.");
        Console.ReadLine();
    }
